...
public class OpTests {
    ...
    public void TestOpInsert() throws Exception {
        ...
        op.addDocument(Utils.getMap("test", (Object) "value").add("test2", 123));
        op.addDocument(Utils.getMap("test", (Object) "value2").add("test2", 124));
    ...
    public void TestOpDelete() throws Exception {
        ...
        op.setMessageId(42);
        op.setResponseTo(12345);
        op.setSelector(Utils.getMap("test", (Object) "value").add("test2", 123));
    ...
    public void TestOpReply() throws Exception {
        ...
        op.addDocument(Utils.getMap("test", (Object) 123).add("value", "val"));
        op.addDocument(Utils.getMap("test", (Object) 42).add("value", "val2"));
        op.setNumReturned(2);
        op.setStartFrom(123);
    ...
    public void TestOpUpdate() throws Exception {
        ...
        op.setSelector(Utils.getMap("test", 123));
        op.setUpdate(Utils.getMap("$set", Utils.getMap("test", 1222)));
    ...
    public void TestOpMsg() throws Exception {
        ...
        op.setFirstDoc(Utils.getMap("$cmd", Utils.getMap("hello", 1)));
        op.setFirstDoc(Utils.getMap("$find", Utils.getMap("test", 42)));
